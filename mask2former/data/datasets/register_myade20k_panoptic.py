...
ADE20K_150_CATEGORIES = [
    {"color": [0, 0, 0], "id": -1, "isthing": 0, "name": "void"},
...
for entry in ADE20K_150_CATEGORIES:
    entry['id'] += 1

ADE20k_COLORS = [k["color"] for k in ADE20K_150_CATEGORIES]

MetadataCatalog.get("myade20k_sem_seg_train").set(
    stuff_colors=ADE20k_COLORS[:],
)

MetadataCatalog.get("myade20k_sem_seg_val").set(
    stuff_colors=ADE20k_COLORS[:],
)
...
_PREDEFINED_SPLITS_ADE20K_PANOPTIC = {
    "myade20k_panoptic_train": (
        "ADEChallengeData2016/images/training",
        "ADEChallengeData2016/myade20k_panoptic_train",
        "ADEChallengeData2016/myade20k_panoptic_train.json",
        "ADEChallengeData2016/annotations/training",  # Use the one starting from 0
        "ADEChallengeData2016/ade20k_instance_train.json",
    ),
    "myade20k_panoptic_val": (
        "ADEChallengeData2016/images/validation",
        "ADEChallengeData2016/myade20k_panoptic_val",
        "ADEChallengeData2016/myade20k_panoptic_val.json",
        "ADEChallengeData2016/annotations/validation",  # Use the one starting from 0
